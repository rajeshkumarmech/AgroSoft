    ...
    return Scaffold(
      ...
      body: ListView(
        children: [
          ...
          Inputform(label: 'Phone', controller: phone),
          Inputform(label: ' Address', controller: address),
          Inputform(label: ' GST IN', controller: address),
          Inputform(label: ' SL NO', controller: address),
          Inputform(label: ' FMS', controller: address),
          Inputform(label: ' FL NO', controller: address),
          Inputform(label: ' PL NO', controller: address),
          Inputform(label: ' DL NO', controller: address),
          Inputform(label: 'Bank Name', controller: address),
          Inputform(label: 'Account NO', controller: address),
          Inputform(label: 'IFSC Code', controller: address),
          Inputform(label: 'Price Group', controller: address),
