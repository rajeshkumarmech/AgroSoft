...
import '../../../../Screen/Transaction/Payment/add_payment.dart';

class StatementsSample extends StatefulWidget {
  const StatementsSample({super.key});

  @override
  State<StatementsSample> createState() => _StatementsSampleState();
}

class _StatementsSampleState extends State<StatementsSample> {
  ...
  Widget build(BuildContext context) {
    ...
    // String productname = 'Sample Ledger';
    return Scaffold(
      appBar: AppBar(
            ...
            Container(
              ...
              child: Column(
                ...
                children: [
                  ...
                  _details("Account Name", ""),
                  const DropdownButtonWidget(
                    dropDownItem: ['Petty Cash', 'SBI','Select Option'],
