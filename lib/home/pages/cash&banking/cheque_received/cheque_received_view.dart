...
import 'cheque_received_sample.dart';



  class ChequeReceivedView extends StatelessWidget {
    const ChequeReceivedView ({super.key});
        ...
        body: ListView(
          children: [
            ...
            listofsalesorder(size, 'Priya', '09/08/2024 - 10/08/2024', '1530',
                    () {
                      Navigator.of(context).push(MaterialPageRoute(builder: (context)=>const  ChequeReceivedSample()));
