...
class ChequeSample_Received extends StatelessWidget {
  const ChequeSample_Received({super.key});

  @override
  Widget build(BuildContext context) {
    Size size = MediaQuery.of(context).size;
    String productname = 'Cheque View';
    return Scaffold(
      appBar: AppBar(
            ...
            Container(
              ...
              child: Column(
                ...
                children: [
                  ...
                  _details("Remarks","Success"),
                  _details("Deposite Date", "18/11/2024"),
                  _details("Paid Amount", "12,000"),
                  _details("Status", "Received"),
                  SizedBox(
                    height: 50,
                    child: Row(
