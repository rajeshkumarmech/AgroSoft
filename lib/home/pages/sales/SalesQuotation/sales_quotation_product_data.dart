...
class SalesQuotationProductData extends StatefulWidget {
  const SalesQuotationProductData({super.key});

  @override
  State<SalesQuotationProductData> createState() => _SalesQuotationProductDataState();
}

class _SalesQuotationProductDataState extends State<SalesQuotationProductData> {
  @override
              ...
              Container(
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    _details("ID", "1"),
                    _details("Sales Type", "1"),
                    _details("Tax", "1"),
                    _details("Tax Type", "1"),
                    _details("Name", "Dinesh"),
                    _details("Mobile", "8754716572"),
                    _details("Address", "tirupur"),
                    _details("Date", "2023-10-20"),
                    _details("Reference", "	DHASLKJLLL"),
                    _details("Due Date", "2023-10-20"),
                    _details("Discount", "15"),
                    _details("Round", "0"),
                    _details("Total", "1116"),
                  ],
                ),
