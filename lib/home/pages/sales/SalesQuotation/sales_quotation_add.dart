...
import '../SalesOrder/sales_order_view.dart';

class SalesQuotationAdd extends StatelessWidget {
  const SalesQuotationAdd({super.key});
        ...
        children: [
          ...
          Row(
            ...
            children: [
              ...
              MaterialPageRoute(builder: (context) => const SalesOrderView()));
                },
                child: Container(
                  height: 50,
                  width: 200,
