import 'package:agrosoft/home/pages/sales/SalesOrder/sales_order_add.dart';
import 'package:agrosoft/home/pages/sales/SalesOrder/sales_order_product_data.dart';
      ...
      body: ListView(
        children: [
          ...
          listofsalesorder(size, 'Dinesh', '09/08/2024 - 10/08/2024', '1530',(){
            Navigator.of(context).push(
              MaterialPageRoute(builder: (context) => const SalesOrderProductData()));
          })
        ],
      ),
    );
