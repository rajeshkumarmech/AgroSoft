...
class InvoiceProductData extends StatelessWidget {
  const InvoiceProductData({super.key});
              ...
              Container(
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    _details("ID", "1"),
                    _details("Bill No", "R-P-32-24-25"),
                    _details("Name", "Priya"),
                    _details("Mobile", "8754716572"),
                    _details("Date", "2023-10-18:22:48:18"),
                    _details("Reference", "	DHASLKJLLL"),
                    _details("Time", "2023-10-20"),
                    _details("Paid", "0"),
                    _details("Total", "10000"),
