...
class ReceiptSample extends StatelessWidget {
  const ReceiptSample({super.key});
              ...
              Container(
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    _details("ID", "5"),
                    _details("Date", "2024-11-14"),
                    _details("Reference", "77"),
                    _details("Name", "test"),
                    _details("Total", "2000"),
                    _details("Pay Type", "Cash"),
                    _details("Pay Account", "SBI"),
                    _details("Category", "-"),
                    _details("Receipt Type", "3"),
                    _details("Remarks", "Auto Test Allocation"),
