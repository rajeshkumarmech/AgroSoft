...
class Return_Sample1 extends StatelessWidget {
  const Return_Sample1({super.key});
              ...
              Container(
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    _details("ID", "2"),
                    _details("Purchase Type", "SS"),
                    _details("Bill No", "SS-14"),
                    _details("Name", "Satheesh"),
                    _details("Address", "123 Main Street"),
                    _details("Date", "2024-10-01"),
