...
import 'package:agrosoft/Screen/purchase.new/return_invoice/return_invoice_sample.dart';
import 'package:agrosoft/Screen/purchase.new/return_invoice_new/return_invoicesample_new.dart';
import 'package:flutter/material.dart';

import '../../../home/pages/sales/Invoice/add_invoice.dart';
import '../../../home/pages/sales/Invoice/invoice_product_data.dart';

class Return_Invoice1 extends StatelessWidget {
  const Return_Invoice1 ({super.key});
      ...
      body: ListView(
        children: [
          ...
          listofsalesorder(size, 'Dinesh', '09/08/2024 - 10/08/2024', '1530',(){
            Navigator.of(context).push(
                MaterialPageRoute(builder: (context) => const Return_Sample1()));
          }),
        ],
      ),
    );
