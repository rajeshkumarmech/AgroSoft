...
class PurchaseOrderSample extends StatelessWidget {
  const PurchaseOrderSample({super.key});
              ...
              Container(
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    _details("Tax", "1"),
                    _details("Tax Type", "1"),
                    _details("Name", "Mounaguru"),
                    _details("Address", "Sulur,Coimbatore"),
                    _details("Date", "2024-11-11"),
                    _details("Reference", "ref"),
                    _details("Freight", "0"),
                    _details("Others", "0"),
                    _details("Discount", "20"),
                    _details("Round", "0.5"),
                    _details("Total", "21000"),
