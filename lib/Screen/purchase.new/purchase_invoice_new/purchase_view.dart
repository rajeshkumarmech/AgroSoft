...
import '../grn/grn_sample.dart';

class PurchaseView_new extends StatelessWidget {
  const PurchaseView_new ({super.key});
      ...
      body: ListView(
        children: [
          ...
          listofsalesorder(size, 'Dinesh', '09/08/2024 - 10/08/2024', '1530',(){
            Navigator.of(context).push(
                MaterialPageRoute(builder: (context) => const PurchaseInvoiceData()));
          }),
        ],
      ),
    );
