...
class PurchaseInvoiceData_new extends StatelessWidget {
  const PurchaseInvoiceData_new({super.key});
              ...
              Container(
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    _details("ID", "1"),
                    _details("Purchase Type", "Wholesale B-B"),
                    _details("Bill No", "W-4"),
                    _details("Reference", "Priya"),
                    _details("Name", "Bharath"),
                    _details("Address", "Sulur"),
