...
class purchase_report_HSN_page extends StatefulWidget {
  const purchase_report_HSN_page({super.key});

  @override
  State<purchase_report_HSN_page> createState() => _purchase_report_HSN_pageState();
}

class _purchase_report_HSN_pageState extends State<purchase_report_HSN_page> {
 @override
