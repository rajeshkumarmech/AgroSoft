...
class PurschaseReportpage extends StatefulWidget {
  const PurschaseReportpage({super.key});

  @override
  State<PurschaseReportpage> createState() => _PurschaseReportpageState();
}

class _PurschaseReportpageState extends State<PurschaseReportpage> {
 @override
