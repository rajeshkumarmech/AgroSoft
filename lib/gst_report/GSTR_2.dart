...
class GSTR_2page extends StatefulWidget {
  const GSTR_2page({super.key});

  @override
  State<GSTR_2page> createState() => _GSTR_2pageState();
}

class _GSTR_2pageState extends State<GSTR_2page> {
   @override
