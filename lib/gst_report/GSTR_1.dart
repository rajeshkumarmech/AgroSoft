...
class GSTR_1page extends StatefulWidget {
  const GSTR_1page({super.key});

  @override
  State<GSTR_1page> createState() => _GSTR_1pageState();
}

class _GSTR_1pageState extends State<GSTR_1page> {
    @override
