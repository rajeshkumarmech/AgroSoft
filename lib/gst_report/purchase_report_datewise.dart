...
class PurchaseReportDatewisepage extends StatefulWidget {
  const PurchaseReportDatewisepage({super.key});

  @override
  State<PurchaseReportDatewisepage> createState() => _PurchaseReportDatewisepageState();
}

class _PurchaseReportDatewisepageState extends State<PurchaseReportDatewisepage> {
 @override
